...
//
//    
//    YB_QQLateralSpreadsMenu * menuVC=[[YB_QQLateralSpreadsMenu alloc]init];
//
//    [menuVC makeLeftView:viewleft AndRightView:viewRight WithCentterController:nav];
//    
//    UINavigationController * nav2=[[UINavigationController alloc]initWithRootViewController:menuVC];
//    
//    
//    NSLog(@"%@",NSStringFromCGRect(menuVC.leftView.frame));
